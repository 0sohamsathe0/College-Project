...
const AddMeritCertificate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:3500/admin/add-certificate/merit", formData, {
        headers: {
  ...
  return (
    <div className="text-black font-bold bg-white rounded-3xl p-5 text-xl mt-5 w-full">
      <h2 className="text-center text-3xl py-5 text-[#0b0b51]">Add Merit Certificate</h2>
...
export default AddMeritCertificate;
